...
% Inserting a figure
Here a figure named \textit{BATesting_setup.png} is inserted\footnote{The \textit{BATesting_setup.png} file is located in the figs folder.}:
\begin{figure}[h]
  \centering
  \includegraphics[width=50mm]{BATesting_setup.png}
  \caption{Caption example}
  \label{fig:BATesting_setup}
\end{figure}
